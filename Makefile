...
SRCPATH=$(PWD)/src
O=json-parser.o json-builder.o Main.o App.o StdString.o Util.o Log.o Input.o Buffer.o Widget.o Image.o Resource.o Sprite.o SpriteGroup.o SpriteHandle.o Panel.o Label.o Font.o Ui.o UiConfiguration.o Color.o Position.o ComboBox.o Prng.o HashMap.o Network.o AgentControl.o SystemInterface.o Json.o MediaUi.o ImageWindow.o LabelWindow.o MediaWindow.o StringList.o TooltipWindow.o Button.o LinkClient.o RecordStore.o LinkUi.o Toggle.o UiText.o TextField.o Toolbar.o WidgetHandle.o ProgressBar.o Menu.o TextFieldWindow.o ScrollView.o CardView.o ActionWindow.o TextArea.o ToggleWindow.o DisplayServerWindow.o DisplayUi.o Chip.o MediaItemUi.o ThumbnailWindow.o StreamWindow.o StreamItemUi.o TimelineBar.o NewsWindow.o IconCardWindow.o ListView.o SettingsWindow.o Slider.o SliderWindow.o RowView.o IconLabelWindow.o MainUi.o UiLaunchWindow.o LogoWindow.o HelpWindow.o NewsItemWindow.o TaskItemWindow.o ScrollBar.o StatsWindow.o SnackbarWindow.o HelpActionWindow.o AgentConfigurationWindow.o WebKioskUi.o WebKioskWindow.o AgentStatusWindow.o WebDisplayIntentWindow.o Ipv4Address.o HyperlinkWindow.o
VPATH=$(SRCPATH)
